...
window.pokeAPI.forEach((pokemon) => {
...
async function createGame() {
  shuffledPokemonIds.forEach((pokemonId) => {
    const pokemonData = pokemonAPI[pokemonId];
    createPokemonBox(pokemonData);
  });
}
